sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.epc.controller.Page3", {
		handleRouteMatched: function(oEvent) {
			...
			if (!this.sContext) {
				this.sContext = "Sheet1Set('1908754')";
			}
		...
		_onButtonPress1: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				.then(function(result) {
					return new Promise(function(fnResolve) {
						sap.m.MessageBox.confirm("Confirma desea adjuntar estos documentos", {
							title: "Adjuntar",
							actions: ["Adjuntar", "Cancelar"],
							onClose: function(sActionClicked) {
								fnResolve(sActionClicked === "Adjuntar");
							}
						});
					});
